...
int main(void)
{
  ...
  MX_USB_HOST_Init();
  /* USER CODE BEGIN 2 */
  // Optional: Add any startup code here
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    // OPTIONAL: Manual file operations example
    // You can call File_Handling functions here if needed
    // For example, based on keyboard input or other conditions:
    /*
    if (some_condition) {
      Write_File("data.txt", "New data\r\n");
      Update_File("log.txt", "Log entry\r\n");
    }
    */
...
static void MX_GPIO_Init(void)
{
  ...
  /* Configure GPIO pin Output Level for LED (PA0) */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0, GPIO_PIN_RESET);

  /* Configure GPIO pin : PA0 (User LED) */
